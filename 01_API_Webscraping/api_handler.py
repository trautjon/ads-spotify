...
# Pfad zum aktuellen Skript (api_handler.py)
script_directory = os.path.dirname(os.path.abspath(__file__))
 
# Pfad zur 'api-keys.json'
keys_file_path = os.path.join(script_directory, 'api-keys.json')
 
# Öffnen Sie die Datei mit dem absoluten Pfad
with open(keys_file_path, 'r') as key_datei:
    key_daten = json.load(key_datei)


client_id = key_daten["client_id"]
client_secret = key_daten["client_secret"]
